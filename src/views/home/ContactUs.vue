        ...
        <div class="col-md-4">
          <div class="card h-100 text-center contact-info-card">
            <div class="card-body">
              ...
              <p class="card-text"
                >123 Business Street<br />Suite 100<br />New York, NY 10001</p
              >
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="card h-100 text-center contact-info-card">
            <div class="card-body">
              ...
              <p class="card-text"
                >+1 (555) 123-4567<br />Monday-Friday: 9am-5pm</p
              >
            </div>
          </div>
        </div>
          ...
          <div
            ...
            <div class="accordion-item">
              ...
              <div
                ...
                data-bs-parent="#faqAccordion">
                <div class="accordion-body">
                  You can schedule a consultation by filling out our contact
                  form or calling our office directly.
                </div>
              </div>
            </div>
            <div class="accordion-item">
              ...
              <div
                ...
                data-bs-parent="#faqAccordion">
                <div class="accordion-body">
                  Yes, we offer virtual meetings via Zoom, Teams, or other
                  platforms based on your preference.
                </div>
              </div>
            </div>
          </div>
